...
#    When Chat widget open minimize it
    ...
    Examples:
      ...
      | stg         | attachment | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | ace        | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | briefing   | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | dnd        | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | ecchi      | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | haku       | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | igc        | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | kokuyo     | AU           | Australia    | VISA/MASTER    | P@ss12345 |
...
#      | stg         | makuake    | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      ...
      | stg         | toot       | AU           | Australia    | VISA/MASTER    | P@ss12345 |
      | stg         | xgirl      | CA           | Canada       | VISA/MASTER    | P@ss12345 |
      | stg         | xlarge     | CA           | Canada       | VISA/MASTER    | P@ss12345 |
